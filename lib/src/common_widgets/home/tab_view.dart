...
class CustomTabViewI extends StatelessWidget {
  ...
  const CustomTabViewI({super.key, required this.productCart, required this.productName, required this.productImage, this.scrollDirection = Axis.vertical});
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        CustomProductMenu(productImage: productImage, productName: productName, scrollDirection: scrollDirection,)
      ],
    );
  }
}